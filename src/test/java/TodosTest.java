...
//EpicSearchWorksRelevantValue3
    ...
    @Test
    public void TodosMeetingSearchWorksRelevantValueTopic() { // корректное значение topic для Meeting
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
    ...
    @Test
    public void TodosMeetingSearchWorksRelevantValueProject() { // корректное значение project для Meeting
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
    ...
    @Test
    public void TodosEpicSearchWorksRelevantValue1() { // корректное значение 1 для Epic
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
    ...
    @Test
    public void TodosEpicSearchWorksRelevantValue2() { // корректное значение 2 для Epic
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
